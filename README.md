...
In biology, there are many ways to solve a task. However, biologists sometimes we need simple ways to get easy tasks done quick (without actually compromising efficiency and accuracy). If that is what you need, this page might help you. I started working on bioinformatics from scratch a few years ago. I didn't know much about scripting and I was always trying to solve everything with one-line commands. Over the years, I used many one-line commands and found myself re-using them many times. Therefore, I finally decided to gather them all in the following list (which I will keep updating every time I use a new one). Here you can find some commands which are useful for different bioinformatics purposes. Of course, all in one line. Cheers!
